...
public partial class TpContext : DbContext
{
    ...
    public virtual DbSet<Tripsdetail> Tripsdetail { get; set; }

    /*public virtual DbSet<tripdetailsdto> Tripsdetailsdto { get; set; }

    public virtual DbSet<placesdetailsdto> Placesdetailsdto { get; set; }

    public virtual DbSet<memberdetailsdto> Membersdetailsdto { get; set; }*/
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Tripsdetail>(entity =>
        {
            entity.HasKey(e => e.Userid).HasName("PRIMARY");

            entity.ToTable("tripsdetails");
